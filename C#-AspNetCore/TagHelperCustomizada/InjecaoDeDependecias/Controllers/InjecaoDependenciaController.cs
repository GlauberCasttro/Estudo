    ...
    public class InjecaoDependenciaController : Controller
    {
        ...
        public string Index()
        {
            return "Primera instãncia: " + Environment.NewLine +
                OperacaoServices1.Transient.OperacaoId + " Transient - Obtém um anova instancia do objeto para cada solicitação" + Environment.NewLine + 
                OperacaoServices1.Scoped.OperacaoId + " Scoped - Reutiliza a mesma instancia do obejto durante todo o request" + Environment.NewLine +
